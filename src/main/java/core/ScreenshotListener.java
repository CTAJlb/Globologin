...
public class ScreenshotListener extends TestListenerAdapter {
    ...
    public void onTestFailure(ITestResult tr) {
        ...
        System.out.println("Written screenshot to: http://206.54.160.3:8080/job/Globologin/ws/screenshots/" + filename);
        Reporter.log("Written screenshot to: <a target=\"_blank\" href=\"http://206.54.160.3:8080/job/Globologin/ws/screenshots/" + filename + "\">click to see this screenshot</a>");
